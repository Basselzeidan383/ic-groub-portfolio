...
function language() {
  if (window.localStorage.getItem("language") == "ar") {
    document.querySelector(".logo").innerHTML = "باسل زيدان";
    ...
    document.querySelector(".land-left h1").innerHTML = "مرحبا, فى عالم زيدان";
    ...
    document.querySelector("h3.mf").innerHTML = "باسل زيدان";
    ...
    document.querySelector(".footer h3").innerHTML = "باسل زيدان";
    ...
    document.querySelector(".footer .copyright").innerHTML =
      " مصنوع من <3 بواسطة ياسل";
    phrases = [
      "مرحبا بك فى عالم اي سي جروب",
      "مرحبا بك فى عالم باسل",
      "صناعه باسل زيدان",
      "حدثه باسل زيدان",
    ];
    ...
    document.querySelector(".logo").innerHTML = "Bassel Zeidan";
    ...
    document.querySelector(".testimonials .main-title").innerHTML =
      "Testimonials";
    document.querySelector("h3.mf").innerHTML = "Bassel Zeidan";
    ...
    document.querySelector(".footer h3").innerHTML = "B.Zeidan";
    document.querySelector(".footer .text").innerHTML =
    ...
    document.querySelector(".footer .copyright").innerHTML =
      "Made With <3 By Bassel";
    phrases = [
      "Welcome To Ic Group",
      "Welcome To Bassel World",
      "Made With Bassel Zeidan",
      "Update With Bassel Zeidan",
    ];
    document.querySelector(".landing .land-left h1").style.borderRight =
      "5px solid";
    document.querySelector(".landing .land-left h1").style.borderLeft =
